  ...
  return (
    <div>
      <div className="relative py-3 flex flex-col gap-4 w-full">
        <div className="border border-gray-100/20 rounded-md overflow-hidden">
          <Link href={url}>
            <a
        ...
        <div className="text-center">
          <h3 className="text-xl text-gray-900 tracking-wider dark:text-gray-100">
            {name}
          </h3>
          <p className="pb-4 pt-2 text-gray-400">{tech}</p>
          <Link href={url}>
            <a
              target="_blank"
